...
internal sealed class ScriptKeywordProcessor : UnityEditor.AssetModificationProcessor
{
    ...
    public static void OnWillCreateAsset(string path)
    {
        ...
        file = file.Replace("#PROJECTNAME#", "Hexwar");//PlayerSettings.productName);
        file = file.Replace("#DEVELOPERNAME#", Environment.UserName);
        file = file.Replace("#COMPANY#", COMPANY + " - " + WEBSITE);
